...
// Dashboard Stats & Performance API
export const dashboardAPI = {
  getStats: () => fetchAPI('/dashboard/stats'),
  getPerformance: () => fetchAPI('/dashboard/performance'),
  updatePerformance: (metrics) => fetchAPI('/dashboard/performance', { method: 'PUT', body: { metrics } }),
  getPublicStats: () => fetchAPI('/dashboard/public-stats'),
};
...
export const imagesAPI = {
  ...
  delete: (id) => fetchAPI(`/images/${id}`, { method: 'DELETE' }),
};
